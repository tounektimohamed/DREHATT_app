...
class RestaurantStoryViewer extends StatefulWidget {
  final Map<String, dynamic> restaurant;

  const RestaurantStoryViewer({Key? key, required this.restaurant}) : super(key: key);

  @override
  _RestaurantStoryViewerState createState() => _RestaurantStoryViewerState();
}

class _RestaurantStoryViewerState extends State<RestaurantStoryViewer> {
  ...
  void _goToNextStory() {
    if (_currentStoryIndex < (widget.restaurant['stories']?.length ?? 0) - 1) {
  ...
  @override
  Widget build(BuildContext context) {
    final stories = widget.restaurant['stories'] as List<dynamic>? ?? [];
                  ...
                  return Expanded(
                    child: Padding(
                      ...
                      child: LinearProgressIndicator(
                        value: index == _currentStoryIndex ? _progressValue : 
            ...
            Positioned(
              ...
              child: Row(
                children: [
                  CircleAvatar(
                    radius: 20,
                    backgroundImage: widget.restaurant['imageUrl'] != null
