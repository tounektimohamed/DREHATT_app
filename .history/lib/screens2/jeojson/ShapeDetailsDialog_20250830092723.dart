  ...
  void _saveToFirestore() async {
    if (_formKey.currentState?.validate() ?? false) {
      try {
        ...
        if (area <= 0) {
          throw Exception(
              'La superficie doit être un nombre valide et supérieur à 0.');
        }
        ...
        final data = {
          ...
          'coordinates':
              [], // Assurez-vous que ce champ est correctement rempli
        };
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
              content:
                  Text('Erreur lors de l\'enregistrement des données: $e')),
        );
      }
    }
  }
        ...
        child: Form(
          ...
          child: SingleChildScrollView(
            child: Column(
              ...
              children: <Widget>[
                Text('Type de Forme : ${widget.shapeType}',
                ...
                TextFormField(
                  ...
                  decoration:
                      InputDecoration(labelText: 'Numéro de carte d\'identité'),
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                ...
                TextFormField(
                  ...
                  decoration:
                      InputDecoration(labelText: 'Type de preuve de propriété'),
                  validator: (value) {
                    if (value == null || value.isEmpty) {
                ...
                TextFormField(
                  ...
                  decoration:
                      InputDecoration(labelText: 'plans d\'amenagement urbain'),
                  validator: (value) {
                    if (value == null || value.isEmpty) {
