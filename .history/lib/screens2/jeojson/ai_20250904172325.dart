        ...
        child: Column(
          ...
          children: [
            ...
            Wrap(
              ...
              children: [
                ElevatedButton.icon(
                  onPressed: serverStatus == 'Connecté' ? captureAndCompare : null,
                ...
                child: ListView(
                  children: [
                    ...
                    if (annotatedImageUrl != null)
                      _buildImageCard("Image avec différences", annotatedImageUrl!),
                  ],
                ),
              )
              ...
              itemBuilder: (context, index) {
                ...
                return Card(
                  ...
                  child: ListTile(
                    ...
                    subtitle: Text("Date: ${DateTime.parse(timestamp).toLocal().toString()}"),
                    trailing: IconButton(
                      icon: const Icon(Icons.visibility),
                      onPressed: () {
                        final timestamp = DateTime.now().millisecondsSinceEpoch;
                        setState(() {
                          originalImageUrl = "$baseUrl/images/${change['image_path']}?t=$timestamp";
                          if (change['annotated_path'] != null) {
                            annotatedImageUrl = "$baseUrl/images/${change['annotated_path']}?t=$timestamp";
                          }
                          showChanges = false;
                        });
                      },
