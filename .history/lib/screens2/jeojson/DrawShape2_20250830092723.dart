...
class _CombinedMapPageState extends State<CombinedMapPage> {
  ...
  void _showSaveDialog() async {
              ...
              children: [
                TextField(
                  ...
                  decoration: InputDecoration(
                      labelText: 'Nom du demandeur de subdivision'),
                ),
                TextField(
                ...
                TextField(
                  ...
                  decoration: InputDecoration(
                      labelText: 'Modèle d\'aménagement urbain'),
                ),
                TextField(
    ...
    if (result != null) {
      final shapeName =
          result['name'] ?? 'Shape_${DateTime.now().millisecondsSinceEpoch}';
    ...
    if (polygons.isNotEmpty || circles.isNotEmpty || polylines.isNotEmpty) {
      ...
      final shapeData = {
        ...
        'center': selectedShape == DrawShape.circle
            ...
            : null,
        'radius':
            selectedShape == DrawShape.circle ? circles.first.radius : null,
      };
  ...
  void _showSavedShapesList() async {
    ...
    final shapes = querySnapshot.docs
        .map((doc) {
          final data = doc.data();
  ...
  void _centerMapOnShape(String shapeId) async {
    final shapeDoc = await FirebaseFirestore.instance
        .collection('shapes')
        .doc(shapeId)
        .get();
            ...
            setState(() {
              polygons.add(
                Polygon(
                  ...
                  strokeWidth: 2,
                  strokeColor:
                      Colors.green, // Couleur de contour pour la visibilité
                  fillColor: Colors.green.withOpacity(
                      0.5), // Couleur de remplissage pour la visibilité
                ),
              );
            });
          ...
          if (center != null && radius != null) {
            ...
            if (centerLat != null && centerLng != null) {
                ...
                circles.add(
                  Circle(
                    ...
                    fillColor: Colors.orange.withOpacity(
                        0.5), // Couleur de remplissage pour la visibilité
                    strokeColor:
                        Colors.orange, // Couleur du contour pour la visibilité
                  ),
                );
              });
              ...
              _mapController?.animateCamera(
                  CameraUpdate.newLatLngZoom(LatLng(centerLat, centerLng), 15));
            }
          }
          break;
      }
        ...
        children: [
          Expanded(
            ...
            initialCameraPosition: CameraPosition(
              target: LatLng(33.9167, 10.1667), // Initial position (medenine)
              zoom: 10,
            ),
            polygons: polygons,
            polylines: polylines,
          ...
          if (showSaveButton &&
            ...
            Container(
              color: Color.fromARGB(
                  255, 83, 195, 199), // Background color to test visibility
